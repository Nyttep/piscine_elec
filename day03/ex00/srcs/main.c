...
{
	//TIMER1 CONFIG
	//sets the timer as mode 4 (compare mode CTC OCR1A) (p131-132 & p141)
	...
	TIMSK1 |= (1 << OCIE1A);//enabling interrupt on overflow of timer1

	OCR1A = (16000000 / (1024 - 1)); //setting max value of timer1 to (16000000 / (1024 - 1) to get 1Hz(p131-132)
